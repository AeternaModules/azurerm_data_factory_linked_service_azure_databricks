data "azurerm_key_vault_secret" "access_token" {
  for_each     = { for k, v in var.data_factory_linked_service_azure_databricks : k => v if v.access_token_key_vault_id != null && v.access_token_key_vault_secret_name != null }
